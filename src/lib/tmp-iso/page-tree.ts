// lib/tmp-iso/page-tree.ts — Master page tree (srs-automation-tmp.md 7.1) dan
...
export const MASTER_TREE: TreeNode[] = [
  { key: "root", templateTitle: "<YYYYMMDD> - <idProject> - [TEMPLATE] <Project Name>", parent: null, fillable: true },
...
/** Substitusi token `<YYYYMMDD>`, `<idProject>`, `<Project Name>` ke dalam title. */
