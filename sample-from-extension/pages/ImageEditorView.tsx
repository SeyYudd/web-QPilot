...
const colors = ["#2563EB", "#1D4FD7", "#6089E4", "#0F172A", "#ef4444", "#22c55e", "#f59e0b", "#ffffff"];
...
export default function ImageEditorView() {
  ...
  const commitState = (nextItems: Item[], nextImageSrc?: string) => {
    setPast((prev) => [
      ...prev,
      {
        items: clone(items),
  ...
  return (
    <div 
      ...
      style={{
        backgroundColor: "var(--bg-canvas, #E0E9FD)",
    ...
    >
      ...
      >
        <div className="flex flex-col gap-3">
          <button
            ...
            style={{
              backgroundColor: tool === "select" ? "var(--brand-primary, #2563EB)" : "transparent",
          ...
          <button
            ...
            className="rounded-xl p-2.5 transition"
            style={{
              backgroundColor: tool === "draw" ? "var(--brand-primary, #2563EB)" : "transparent",
          ...
          <button
            ...
            className="rounded-xl p-2.5 transition"
            style={{
              backgroundColor: tool === "shape" ? "var(--brand-primary, #2563EB)" : "transparent",
          ...
          <button
            ...
            className="rounded-xl p-2.5 transition"
            style={{
              backgroundColor: tool === "text" ? "var(--brand-primary, #2563EB)" : "transparent",
          ...
          <button
            ...
            className="rounded-xl p-2.5 transition"
            style={{
              backgroundColor: tool === "blur" ? "var(--brand-primary, #2563EB)" : "transparent",
          ...
          <button
            ...
            className="rounded-xl p-2.5 transition"
            style={{
              backgroundColor: cropMode ? "var(--brand-primary, #2563EB)" : "transparent",
      ...
      <div className="flex flex-1 flex-col">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            {tool === "shape" && (
              <div className="flex items-center gap-2 border-l pl-4" style={{ borderColor: "var(--border-subtle, #E2E8F0)" }}>
                <div className="flex rounded-lg p-1" style={{ backgroundColor: "var(--bg-canvas, #E0E9FD)" }}>
                  <button
                    className="rounded-md p-1.5 transition"
                    style={{
                      backgroundColor: activeShape === "rect" ? "var(--brand-primary, #2563EB)" : "transparent",
                  ...
                  <button
                    className="rounded-md p-1.5 transition"
                    style={{
                      backgroundColor: activeShape === "circle" ? "var(--brand-primary, #2563EB)" : "transparent",
                  ...
                  <button
                    className="rounded-md p-1.5 transition"
                    style={{
                      backgroundColor: activeShape === "line" ? "var(--brand-primary, #2563EB)" : "transparent",
                  ...
                  <button
                    className="rounded-md p-1.5 transition"
                    style={{
                      backgroundColor: activeShape === "arrow" ? "var(--brand-primary, #2563EB)" : "transparent",
                ...
                {(activeShape === "rect" || activeShape === "circle") && (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isShapeFilled ? "var(--brand-primary, #2563EB)" : "transparent",
                      color: isShapeFilled ? "var(--text-on-primary, #FFFFFF)" : "var(--brand-primary, #2563EB)",
                    }}
                ...
                {colors.map((c) => (
                  <button
                    ...
                    style={{
                      backgroundColor: c,
                      borderColor: "var(--border-subtle, #E2E8F0)",
                      outlineColor: "var(--brand-primary, #2563EB)",
                    }}
                    onClick={() => setColor(c)}
                  />
                ))}
              ...
              <div className="ml-2 flex items-center gap-2 border-l pl-3" style={{ borderColor: "var(--border-subtle, #E2E8F0)" }}>
                ...
                <div className="relative">
                  <button
                    ...
                    style={{
                      backgroundColor: "var(--brand-accent, #6089E4)",
        ...
        <main 
          ...
          style={{ backgroundColor: "var(--bg-canvas, #E0E9FD)" }}
        >
